...
public final class UtilesEntrada {
    ...
    public static final int leerEntero(String msg, int min, int max) {
        int num;
        boolean esRango;
        do {
            num = leerEntero(msg);
    ...
    public static final boolean leerBolean() {
        boolean esTrue = false;
        boolean esBoolean = false;
        do {
            try {
    ...
    public static final int buscar(int numero, int[] lista) {
        int posicion = 0;
        boolean testOK = true;
        int i = 1;
